package com.mirrorlabs.menupopup;
...
public class PopupMenu {
    ...
    private void setContentView(View contentView) {
        ...
        mHeaderTitleView.setTypeface(Fonts.ICS);
        mHeaderImageView =(ImageView)contentView.findViewById(R.id.header_icon);
    ...
    public void show(View anchor) {
       ...
       // xPos = anchorRect.centerX() - mPopupWindow.getWidth() / 2;
        ...
        //yPos =(screenHeight/2)-(rootHeight+20);;
        ...
        if (onTop) {
            ...
            if (anchorRect.bottom > dyTop) {
                ...
                yPos = anchorRect.top - anchorRect.bottom ;
            }
        } 
            */
    ...
    public void setHeaderIcon(Drawable image ) {
        mHeaderImageView.setImageDrawable(image);
        mHeaderImageView.setVisibility(View.VISIBLE);
        mHeaderImageView.requestFocus();
    }
    ...
    private class MenuItemAdapter extends ArrayAdapter<MenuItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.popupmenu_list_item, null);
                holder = new ViewHolder();
                holder.icon = (ImageView) convertView.findViewById(R.id.icon);
                holder.title = (TextView) convertView.findViewById(R.id.title);
                holder.title.setTypeface(Fonts.ICS);
