...
out:        for (String name : entries) {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v,
        ...
        menu.add(0, MENU_ID_RENAME, 0, "Rename Gesture");
        menu.add(0, MENU_ID_REMOVE, 0, "Delete Gesture");
    }
    ...
    private Dialog createRenameDialog() {
        ...
        ((TextView) layout.findViewById(R.id.label)).setText("Rename Gesture");
